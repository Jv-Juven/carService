...
* 然后，将app/config目录下的app.php.example重命名为app.php
```ruby
...
``` ruby
DROP DATABASE cheshang;
CREATE DATABASE `cheshang` DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci;
