	...
	<div class="violation-container">
		...
		<div class="violation-records clearfix vio-records">
			...
			<div class="vio-records-title">
				车牌号<span class="records-plate">XXXXXX</span> | 发动机号<span class="records-engine"></span> | 车架号<span class="records-frame"></span>
				共有<span class="records-total">3</span>笔违章记录
			</div>
