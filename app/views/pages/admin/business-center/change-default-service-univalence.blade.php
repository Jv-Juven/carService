    ...
    <div class="business-center-content" id="change-service-univalence-content">
        ...
        <table id="service-univalence" class="table table-striped table-bordered table-hover">
            ...
            <tr>
                ...
                <td>企业用户</td>
                <td>
                    <input type="text" class="form-control" value="{{{ $companyExpressUnivalence }}}" id="company-express-univalence" />
                </td>
            </tr>
            <tr>
                <td>企业服务费</td>
                ...
                <td>企业用户</td>
                <td>
                    <input type="text" class="form-control" value="{{{ $companyAgencyUnivalence }}}" id="company-agency-univalence" />
                </td>
            </tr>
            <tr>
                <td>个人服务费</td>
                ...
                <td>个人用户</td>
                <td>
                    <input type="text" class="form-control" value="{{{ $personExpressUnivalence }}}" id="person-express-univalence" />
                </td>
            </tr>
            <tr>
                <td>个人服务费</td>
